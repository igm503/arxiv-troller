...
class PaperAuthor(models.Model):
    ...
    order = models.PositiveIntegerField()  # To preserve author order
...
class Embedding(models.Model):
    paper = models.ForeignKey(Paper, on_delete=models.CASCADE)
    model_name = models.CharField(max_length=100)  # "gemini-embeddings-001", etc.
    embedding_type = models.CharField(max_length=50)  # "title", "abstract", etc.
